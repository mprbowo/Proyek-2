...
<head>
  ...
  <?php $this->load->view('layout/meta'); ?>
	<title>Home - Manusia Peduli Manusia</title>
	...
	<div class="row" id="city">
		<div class="section">
			<div class="col-md-12 text-center">
				<h5 class="font-purple font-bold font-xl">Manusia peduli Manusia/h5>
	...
	<div class="row bg-img" id="rentyour">
		<div class="section font-white">
			<div class="col-md-12 text-center">
				...
				<div class="col-md-6">
				<p class="font-md font-medium">Manusia Peduli Manusia adalah lembaga yang berkhidmat mengangkat harkat martabat masyarakat dhuafa (masyarakat kurang mampu) melalui penghimpunan dana ZISWAF (zakat, infaq, sedekah, dan wakaf) masyarakat dan dana sosial.</p>
				</div>
				<div class="col-md-6">
				<p class="font-md font-medium">Program-program sosial dan pemberdayaan masyarakat tidak mampu yang digulirkan telah menjadikan dana masyarakat yang dihimpun LMI memiliki nilai tambah dan manfaat yang berlipat ganda bagi masyarakat kurang mampu. Karena kami berusaha senantiasa menumbuhkan iklim transparansi dan profesionalitas untuk mengawal amanah masyarakat yang demikian besar. </p>
				</div>
				<br>
			</div>
		</div>
